...
let choice=prompt("Choose one of the options below: 1) display the first contact on the list; 2) show the last contact on the list, 3) add a new contact to the list, 4) display all contacts, or 5) Exit the program.")
